...
(title, video_length_seconds, device, camera_score, battery_score, screen_score, performance_score,
 video_language, download_time_seconds, transcription_time_seconds, analysis_time_seconds)
VALUES
('Review: XYZ Phone', 1023.45, 'XYZ Phone', 8.5, 7.0, 9.0, 8.0, 'en', 4.210, 28.330, 3.950);

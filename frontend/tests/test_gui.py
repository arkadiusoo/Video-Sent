...
class TestGUI:
    ...
    def test_VS_GUI_01_empty_fields(self):
        ...
        results_text = self.driver.find_element(By.CSS_SELECTOR, "p.text-body-secondary").text
        print("aaaa")
        print(results_text)
        assert "Brak wyników." in results_text
    ...
    def test_VS_GUI_02_valid_youtube(self):
        ...
        results = self.driver.find_element(By.TAG_NAME, "h3").text
        assert "Wyniki" in results

    #
    # VS-GUI-03 – Niepoprawny link
    #
    def test_VS_GUI_03_invalid_url(self):
        ...
        # Nadal powinien być placeholder "Brak wyników"
        msg = self.driver.find_element(By.CSS_SELECTOR, "p.text-body-secondary").text
        assert "Brak wyników" in msg

    #
    # VS-GUI-04 – Wybór języka PL/EN
    #
    ...
    #
    # VS-GUI-06 – Prezentacja wyników tekstowych
    #
    def test_VS_GUI_06_results_section(self):
        ...
        heading = self.driver.find_element(By.CSS_SELECTOR, ".card-title").text
        assert "Wyniki" in heading

    #
    # VS-GUI-07 – Wykresy po analizie
    #
    def test_VS_GUI_07_charts_enabled(self):
        # Bez backendu wykresy nie aktywują się → test sprawdza przycisk
        btn = self.driver.find_element(By.CSS_SELECTOR, "button.btn-brand[disabled]")
        assert btn is not None

    #
    # VS-GUI-08 – Zmiana motywu jasny/ciemny
    #
    ...
    #
    # VS-GUI-09 – Zmiana języka interfejsu
    #
    ...
    #
    # VS-GUI-10 – Reset po odświeżeniu strony
    #
